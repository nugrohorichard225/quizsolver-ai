  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 max-w-3xl mx-auto border border-slate-100">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-slate-800 mb-2">Upload Quiz Data</h2>
        <p className="text-slate-500">Paste your raw quiz text or upload a .txt file.</p>
      </div>

      <div className="space-y-6">
        <div className="relative">
          <textarea
            className="w-full h-64 p-4 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50/50 bg-slate-50 text-sm font-mono transition-all outline-none resize-none"
        ...
        <div className="flex items-center justify-between">
           <div className="flex items-center">
             ...
             <button
                ...
                className="flex items-center text-sm text-slate-600 hover:text-indigo-600 font-medium px-4 py-2 rounded-lg hover:bg-slate-50 transition-colors"
             >
           ...
           <div className="flex space-x-3">
             <button
               ...
               disabled={!text.trim()}
               className={`flex items-center px-5 py-2.5 rounded-lg text-white font-medium shadow-md transition-all transform hover:scale-105 active:scale-95 ${
